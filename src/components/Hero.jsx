  ...
  return (
    <section className="flex flex-col md:flex-row justify-between items-center p-4">
      <div className="flex flex-col justify-center items-center text-center md:text-start md:items-start">
        ...
        <p className="text-md px-3 italic">
          Discover top deals, latest trends, and unbeatable prices—all in one
          place.
        </p>
        <Link to="products" smooth={true} duration={500}>
          <button className="bg-orange-600 text-white px-5 md:ml-3 py-2 rounded-full mt-4 hover:bg-orange-700">
            Shop Now
          </button>
        </Link>
      </div>
